...
ctx.run('/home/' + username + '/.local/bin/ansible-playbook /repos/serenity/playbooks/ini-nexus.yml')
ctx.run('/home/' + username + '/.local/bin/ansible-playbook /repos/serenity/playbooks/cfg-nexus.yml')
